...
export default class App extends Component {
  constructor() {
    ...
    this.state = {
      ...
      markers: [
        { id: 0, title: "0", LatLng: { latitude: 37.78825, longitude: -122.4324 } },
        { id: 1, title: "1", LatLng: { latitude: 37.77825, longitude: -122.4424 } },
        { id: 2, title: "2", LatLng: { latitude: 37.76825, longitude: -122.4524 } },
        { id: 3, title: "3", LatLng: { latitude: 37.75825, longitude: -122.4624 } },
        { id: 4, title: "4", LatLng: { latitude: 37.74825, longitude: -122.4724 } }
      ]
    };
  }
            ...
            >
              <View
                ...
                style={{
                  width: 20,
                  height: 20,
                  backgroundColor: this.state.selectedId === value.id ? "orange" : "#fff",
                  borderColor: "#000",
                  borderWidth: 1,
                  borderRadius: 4,
                  justifyContent: "center",
